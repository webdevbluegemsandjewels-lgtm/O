...
-- =========================================================
-- Making charge is back to weight-based (₹3,500/gram), not flat —
-- but floored at ₹3,500 so it never drops below that even for pieces
-- under 1g. Since gold_weight_grams is now the 9kt (lightest/
-- baseline) weight and 14kt/18kt scale heavier, this makes making
-- charge increase for 14kt/18kt automatically, same as gold_cost does.
-- Safe to re-run.
-- =========================================================
